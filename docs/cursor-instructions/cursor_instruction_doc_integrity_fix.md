...
docs/specification/logic/ui-shared.md（気配りタブ関連削除）
...
docs/ai-context/FILE_MAP.md（廃止タブ表更新・crossref修正）
```
...
├── ai-context/FILE_MAP.md           ← AI向けファイルマップ
...
- [ ] `docs/ai-context/FILE_MAP.md` の crossref が正しいセクション番号を指している
