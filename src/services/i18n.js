...
export const L={
  ja:{
    ...
    summaryImageLbl:'回答画像をアップロードしてください',
    summaryImageNote:'JPEG / PNG / WebP / GIF',
    summaryImageFormatError:'JPEG / PNG / WebP / GIF の画像ファイルを選択してください。',
    ...
    thinkingStepLbl:'ステップ',
    thinkingStepCharTarget:'（目安 {n} 字）',
    thinkingSubmitStepBtn:'この回答を送信する',
    thinkingProceedBtn:'このまま次へ進む',
    thinkingFollowupLbl:'上司からのフィードバック',
    thinkingClosedLbl:'打ち切り',
    thinkingClosedDesc:'80点に届きませんでした。次回の参考にしてください。',
    thinkingFinalQDesc:'2文以内・100字以内でまとめてください',
    thinkingFinalHintLbl:'もう一歩です：',
    thinkingReviseAndSubmitBtn:'修正して最終回答を送信する',
    thinkingFinalFbLbl:'最終フィードバック',
    thinkingReflectDesc:'以下の問いかけは任意です。',
    thinkingReflectPlaceholder:'振り返りを入力...',
    thinkingSessionDoneLbl:'セッション完了',
    thinkingNextBtn:'次へ進む',
    thinkingReviseBtn:'修正して再回答する',
  ...
  en:{
    ...
    summaryImageLbl:'Upload an answer image',
    summaryImageNote:'JPEG / PNG / WebP / GIF',
    summaryImageFormatError:'Please select a JPEG, PNG, WebP, or GIF image.',
    ...
    thinkingStepLbl:'Step',
    thinkingStepCharTarget:'({n} chars)',
    thinkingSubmitStepBtn:'Submit this answer',
    thinkingProceedBtn:'Proceed to next step',
    thinkingFollowupLbl:'Manager feedback',
    thinkingClosedLbl:'Session ended',
    thinkingClosedDesc:'Could not reach 80 points.',
    thinkingFinalQDesc:'2 sentences or less, 100 characters',
    thinkingFinalHintLbl:'Almost there:',
    thinkingReviseAndSubmitBtn:'Revise and submit final answer',
    thinkingFinalFbLbl:'Final feedback',
    thinkingReflectDesc:'The following is optional.',
    thinkingReflectPlaceholder:'Your reflection...',
    thinkingSessionDoneLbl:'Session complete',
    thinkingNextBtn:'Continue',
    thinkingReviseBtn:'Revise and resubmit',
