...
const THINKING_CORE_DEFAULT_USER_CORE = {
  ja: {
...
const THINKING_FINAL_Q_CRITERIA = {
  ja: {
    required: [
...
// ── 問い返しパターン（役割B） ─────────────────────────
const THINKING_FOLLOWUP_PATTERNS = {
  1: { // 状況を整理する
...
// ── 振り返り問いかけパターン（役割D1） ───────────────
const THINKING_REFLECTION_PATTERNS = {
  X: { // 省略・混同への問いかけ
