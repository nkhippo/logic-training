/* State */
// ── State ─────────────────────────────────────────────────
const st={lang:'ja',fDiff:0,sDiff:0,cDiff:0,sVolume:'',fDocType:'',sDocType:'',cDocType:'',aDocType:'',industry:'',personas:[],tenure:'',taDiff:0,taFinalMode:'logic',taScene:'',tsumiaage:null,taPast:[],taFilter:'all',answerMode:'text',answerScope:'s',fFilter:'all',sFilter:'all',cFilter:'all',aFilter:'all',kbFilter:'all',fPast:[],sPast:[],cPast:[],fill:null,summary:null,critique:null,ame:null,aPast:[],aDiff:0,kibariDiff:0,kibariScene:'',kibari:null,kibariPast:null,kbPast:[],genBusy:null,genPhase:null,gradeBusy:null,gradePhase:null};
